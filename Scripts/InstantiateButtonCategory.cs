...
public class InstantiateButtonCategory : MonoBehaviour
{
    ...
    public void CreateButtons()
    {
        for (int i = 0; i < 5; i++)
        {
            ...
            button.GetComponentInChildren<TextMeshProUGUI>().name = button.name;
    ...
    public void LoadIndexOfCompletedListButton()
    {
